...
output_file = '../data/Encoded_data_final-2.csv'
...
def model_builder_evaluator():
  print(f"The dataset before feature engineering and encoding has shape of {stat_model.data.shape}")
  ...
  print("\n=======================================================================================\n")
  print("Optimum model training starting here")
  stat_model.build_model(encoded_features, target="TotalPremium", model_type="random_forest")

  print("\n=======================================================================================\n")
  print("Evaluating decison tree")
  stat_model.evaluate_model(model_type='decision_tree')
  print("\n=======================================================================================\n")
  print("Evaluating random forest")
  stat_model.evaluate_model(model_type='random_forst')
  print("\n=======================================================================================\n")
  print("Evaluating XGBoost")
  stat_model.evaluate_model(model_type='xgb')
